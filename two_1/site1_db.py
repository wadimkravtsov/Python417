...
DATABASE = 'flsk1.db'
DEBUG = True
SECRET_KEY = 'd6e3f8dc1f7c08733447211ab2d4afe6cecd7c6c'

app = Flask(__name__)
app.config.from_object(__name__)
app.config.update(DATABASE=os.path.join(app.root_path, 'flsk1.db'))
...
def create_db():
    db = connect_db()
    with app.open_resource('sq1_db.sql', mode='r') as f:
